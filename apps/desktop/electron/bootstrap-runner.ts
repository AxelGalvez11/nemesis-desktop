...
// checkout under the Nemesis runtime home. Used as a last-resort fallback when
...
function downloadInstallScript(commit, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/AxelGalvez11/nemesis-desktop/${commit}/scripts/${scriptName}`
