...
export const en = {
    ...
    boot: {
        ready: 'Nemesis Desktop is ready',
        ...
        errors: {
            ...
            backgroundExitedDuringStartup: 'Nemesis background process exited during startup.',
    ...
    notifications: {
        ...
        backendOutOfDateMessage: 'Your Nemesis backend is older than this desktop build and may not work correctly. Update to align them.',
        ...
        errors: {
            ...
            methodNotAllowed: 'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nemesis Desktop.',
        ...
        native: {
            ...
            inputBody: 'Nemesis is waiting for your response.',
            turnDoneTitle: 'Nemesis finished',
    ...
    settings: {
        ...
        resetConfirm: 'Reset all settings to Nemesis defaults?',
        ...
        notifications: {
            ...
            focusedHint: 'Completion alerts only fire while Nemesis is in the background.',
            kinds: {
                approval: {
                ...
                input: {
                    label: 'Input needed',
                    description: 'Nemesis asked a question or needs a password or secret.'
                },
                turnDone: {
                    label: 'Response ready',
                    description: 'A turn finished while Nemesis was in the background.'
                },
                turnError: {
                    label: 'Turn failed',
        ...
        appearance: {
            ...
            colorModeDesc: 'Pick a fixed mode or let Nemesis follow your system setting.',
            ...
            pet: {
                title: 'Pet',
                intro: 'Adopt an animated petdex mascot that floats over the app and reacts to what Nemesis is doing — running while tools execute, celebrating on success, sulking on errors.',
                restartHint: 'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Nemesis, then come back here.',
                on: 'On',
                off: 'Off',
                scaleTitle: 'Size',
        ...
        about: {
            ...
            automaticUpdatesDesc: 'Nemesis checks for updates automatically in the background and lets you know when one is ready.',
        ...
        config: {
            ...
            loading: 'Loading Nemesis configuration...',
        ...
        gateway: {
            ...
            intro: 'Nemesis Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Nemesis backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
            ...
            localDesc: 'Start a private Nemesis backend on localhost. This is the default and works offline.',
            remoteTitle: 'Remote gateway',
            remoteDesc: 'Connect this desktop shell to a remote Nemesis backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
            ...
            restartingMessage: 'Nemesis Desktop will reconnect using the saved settings.',
            savedMessage: 'Saved for the next restart.',
            connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nemesis ${version}` : ''}`,
        ...
        providers: {
            ...
            intro: 'Sign in with a subscription — no API key to copy. Nemesis runs the browser sign-in for you, right here in the app.',
            connected: 'Connected',
            collapse: 'Collapse',
    ...
    starmap: {
        ...
        emptyDesc: 'As Nemesis builds skills and memories for your work, they appear here.',
        share: 'Share map',
    ...
    commandCenter: {
        ...
        pets: {
            ...
            staleBackend: 'Restart Nemesis to use pets — the backend predates this feature.',
        ...
        generatePet: {
            ...
            staleBackend: 'Update Nemesis to generate pets.',
            backgroundHint: 'You can close this — Nemesis will notify you when it’s done.',
        ...
        nav: {
            ...
            settings: { title: 'Settings', detail: 'Configure Nemesis desktop' },
    ...
    profiles: {
        ...
        deleting: 'Deleting...',
        createDesc: 'Profiles are independent Nemesis environments: separate config, skills, and SOUL.md.',
        nameLabel: 'Name',
    ...
    cron: {
        ...
        newCron: 'New cron',
        emptyDescNew: 'Schedule a prompt to run on a cron expression. Nemesis will run it and deliver results to the destination you pick.',
    ...
    sidebar: {
        ...
        projects: {
            ...
            staleBackend: 'Update the Nemesis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
            deleteConfirm: 'This removes the saved project from Nemesis. Files, git repos, and worktrees stay untouched.',
    ...
    composer: {
        ...
        placeholderStarting: 'Starting Nemesis...',
        placeholderReconnecting: 'Reconnecting to Nemesis…',
        ...
        attachUrlDesc: 'Nemesis will fetch the page and include it as context for this turn.',
    ...
    statusStack: {
        ...
        coding: {
            ...
            agentShip: 'Ask Nemesis to open PR',
    ...
    updates: {
        stages: {
            ...
            pull: 'Almost there…',
            pydeps: 'Finishing up…',
            update: 'Updating Nemesis…',
            rebuild: 'Rebuilding the desktop app…',
            restart: 'Restarting Nemesis…',
        ...
        unsupportedMessage: 'This version of Nemesis can’t update itself from inside the app.',
        ...
        availableBody: 'A new version of Nemesis is ready to install.',
        availableTitleBackend: 'Backend update available',
        availableBodyBackend: 'A newer version of the connected Nemesis backend is ready to install.',
        availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
        updateNow: 'Update now',
        maybeLater: 'Maybe later',
        moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
        manualTitle: 'Update from your terminal',
        manualBody: 'You installed Nemesis from the command line, so updates run there too. Paste this into your terminal:',
        manualPickedUp: 'Nemesis will pick up the new version next time you launch it.',
        guiSkewTitle: 'Update the desktop app',
        guiSkewBody: 'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nemesis desktop app (your AppImage / .deb / .rpm) to match.',
        copy: 'Copy',
        copied: 'Copied',
        done: 'Done',
        applyingBody: 'The Nemesis updater takes over in its own window and reopens Nemesis automatically when it’s done. Please don’t reopen Nemesis yourself while it’s updating.',
        applyingBodyBackend: 'The remote backend is applying the update and will restart. Nemesis reconnects automatically when it’s back.',
        applyingClose: 'This window will close while the update runs, then Nemesis reopens on its own.',
    ...
    install: {
        ...
        oneTimeTitle: 'Nemesis needs a one-time install',
        ...
        failedTitle: 'Setup hit a snag',
        settingUpTitle: 'Setting up Nemesis',
        finishingTitle: 'Almost there',
        failedDesc: 'One of the setup steps didn’t finish. Close any other Nemesis windows, then retry — the details below show exactly what happened.',
        activeDesc: 'First launch only — Nemesis is downloading its study tools and setting itself up on this computer. This takes a few minutes and won’t happen again.',
        progress: (completed, total) => `${completed} of ${total} steps done`,
        currentStage: stage => ` — now: ${stage}`,
        fetchingManifest: 'Getting things ready…',
        error: 'Error',
        hideOutput: 'Hide details',
    ...
    onboarding: {
        headerTitle: "Let's get you setup with Nemesis Agent",
        headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
        preparingInstall: 'Nemesis is finishing install. This usually takes under a minute on first run.',
        starting: 'Starting Nemesis…',
        ...
        recommended: 'Recommended',
        connected: 'Connected',
        featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nemesis',
        ...
        apiKeyOptions: {
            ...
            local: {
                short: 'self-hosted',
                description: 'Point Nemesis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
            }
        },
        ...
        flowSubtitles: {
            ...
            device_code: 'Opens a verification page in your browser — Nemesis connects automatically',
        ...
        authorizeThere: 'Authorize Nemesis there.',
        ...
        autoBrowser: provider => `We opened ${provider} in your browser. Authorize Nemesis there and you'll be connected automatically — nothing to copy or paste.`,
    ...
    shell: {
        ...
        statusbar: {
            ...
            desktopVersion: version => `Nemesis Desktop v${version}`,
            ...
            gatewayTitle: 'Nemesis inference gateway status',
            agents: 'Agents',
    ...
    preview: {
        ...
        largeBody: (label, size) => `${label} is ${size}. Nemesis will only show the first 512 KB.`,
        ...
        web: {
            ...
            tryAgain: 'Try again',
            restarting: 'Nemesis is restarting...',
            askRestart: 'Ask Nemesis to restart the server',
            lookingRestart: taskId => `Nemesis is looking for a preview server to restart (${taskId})`,
            restartingTitle: 'Restarting preview server',
            restartingMessage: 'Nemesis is working in the background. Watch the preview console for progress.',
            ...
            finishedRestarting: message => `Nemesis finished restarting the preview server${message ? `: ${message}` : ''}`,
            ...
            restartFailedMessage: 'Nemesis could not restart the server.',
            stillWorking: 'Nemesis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
    ...
    assistant: {
        thread: {
            ...
            loadingResponse: 'Nemesis is loading a response',
        ...
        approval: {
            gatewayDisconnected: 'Nemesis gateway is not connected',
            ...
            alwaysDescription: pattern => `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Nemesis won’t ask again for commands like this — in this session or any future one.`,
    ...
    prompts: {
        ...
        sudoDesc: 'Nemesis needs your sudo password to run a privileged command. It is sent only to your local agent.',
        sudoPlaceholder: 'sudo password',
        secretTitle: 'Secret required',
        secretDesc: 'Nemesis needs a credential to continue.',
    ...
    desktop: {
        ...
        restartToUseSaveImage: 'Restart Nemesis Desktop to use Save Image.',
        restartToSaveImages: 'Restart Nemesis Desktop to save images',
