        ...
        <DialogContent className="sm:max-w-sm">
          ...
          {!account.bypass && (
            <div className="rounded-lg border border-border bg-muted/30 px-3 py-2.5">
              <div className="text-sm font-medium">Model access during beta</div>
              <p className="pt-1 text-xs leading-relaxed text-muted-foreground">
                Your Nemesis plan unlocks the desktop app. Model usage is billed separately by the provider you connect
                in Settings → Providers; Nemesis does not mark up those charges.
              </p>
            </div>
          )}
