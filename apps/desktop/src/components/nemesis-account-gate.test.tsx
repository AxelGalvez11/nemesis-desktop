...
import type * as NemesisAccountModule from '@/nemesis-account'

vi.mock('@/nemesis-account', async () => {
  const actual = await vi.importActual<typeof NemesisAccountModule>('@/nemesis-account')
