...
export type QuickActionId = 'explain_simpler' | 'quiz_me' | 'example' | 'why'
export type Surface = 'note' | 'card'
...
const INSTRUCTIONS: Record<QuickActionId, string> = {
...
export const QUICK_ACTIONS: { id: QuickActionId; label: (s: Surface) => string }[] = [
...
export function buildQuickActionPrompt(id: QuickActionId, ctx: NoteChatContext): string {
