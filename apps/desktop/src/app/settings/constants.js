...
export const PROVIDER_GROUPS = [
    {
        prefix: 'NOUS_',
        name: 'Nous Portal',
        description: 'Hosted Nemesis & Nous-trained models',
...
export const FIELD_DESCRIPTIONS = defineFieldCopy({
    ...
    fileReadMaxChars: 'Maximum characters Nemesis can read from one file request.',
    approvals: {
        mode: 'How Nemesis handles commands that need explicit approval.',
    ...
    updates: {
        nonInteractiveLocalChanges: 'When Nemesis updates itself from the app (no terminal prompt), keep local source edits (stash) or throw them away (discard). Terminal updates always ask.'
    }
});
