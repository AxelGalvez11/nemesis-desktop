...
import { wikilinkApplyText, wikilinkCompletionSource, wikilinkOptions, type WikilinkTarget } from './wikilink-autocomplete'
...
describe('wikilink completion apply (end-to-end dispatch)', () => {
  function mountView(doc: string, pos: number): EditorView {
  ...
  function applyCompletion(completion: Completion, view: EditorView, from: number, to: number): void {
