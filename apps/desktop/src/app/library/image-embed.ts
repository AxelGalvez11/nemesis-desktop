...
export function resolveRelativeImageSrc(rawPath: string, noteFolder: string, vaultDir: string): string {
 ...
 *  note's own folder. */
export function resolveEmbeddedImageSrc(rawName: string, files: readonly EmbeddableFile[]): null | string {
