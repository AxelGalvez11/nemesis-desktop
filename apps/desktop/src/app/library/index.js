...
export function LibraryView() {
    ...
    const extractNotesFromSelection = useCallback(() => {
        ...
        const text = `Using ONLY the attached source ("${name}") and no other material, break it into atomic notes — ` +
