...
describe('remappedPath', () => {
    ...
    it('remaps a path nested one level under a renamed folder', () => {
        expect(remappedPath('/vault/OldFolder/Note.md', '/vault/OldFolder', '/vault/NewFolder')).toBe('/vault/NewFolder/Note.md');
    });
    it('remaps a path nested several levels under a renamed folder', () => {
        expect(remappedPath('/vault/OldFolder/sub/deep/Note.md', '/vault/OldFolder', '/vault/NewFolder')).toBe('/vault/NewFolder/sub/deep/Note.md');
    });
