...
import { calloutExtension, codeHighlighting, livePreview, mathBlockExtension, mermaidExtension, noteMarkdown, noteTheme, tableExtension, type ImageContext } from './note-decorations'
