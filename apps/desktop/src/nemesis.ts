...
export const STUDENT_HIDDEN_NAV: ReadonlySet<string> = new Set(['today', 'skills', 'messaging', 'artifacts'])
...
export const STUDENT_HIDDEN_SLASH: ReadonlySet<string> = new Set([
  '/agents',
  '/branch',
  '/browser',
  '/compress',
