...
export const STUDENT_HIDDEN_NAV: ReadonlySet<string> = new Set(['today', 'recorder', 'skills', 'messaging', 'artifacts'])

/** ⌘K palette entries hidden for students. */
export const STUDENT_HIDDEN_PALETTE: ReadonlySet<string> = new Set(['nav-terminal', 'nav-skills', 'nav-messaging', 'nav-recorder'])
