...
AUTHOR_MAP = {
    "axelgalvez1121@gmail.com": "AxelGalvez11",  # Nemesis owner/maintainer
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/AxelGalvez11/nemesis-desktop",
