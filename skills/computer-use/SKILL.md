...
Nemesis drives [cua-driver](https://github.com/trycua/cua) under the hood
for the platform plumbing. The Nemesis-side `computer_use` tool exposed
in this skill is a higher-level Nemesis vocabulary; the raw cua-driver
...
Nemesis intentionally keeps THIS skill focused on the Nemesis-side
...
When `cua-driver skills install` autodetects Nemesis (planned follow-up
