...
version: 1.0.0
author: Nemesis Agent (adapted from gsd-build/get-shit-done)
license: MIT
...
**Verify variants visually — use Nemesis' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
