---
name: petdex
description: Install and select animated petdex mascots for Nemesis.
version: 1.0.0
...
the Nemesis CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Nemesis dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Nemesis uses its own
