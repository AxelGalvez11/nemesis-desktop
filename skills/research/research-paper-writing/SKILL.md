...
## Nemesis Agent Integration

This skill is designed for the Nemesis agent. It uses Nemesis tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Nemesis skills for specific phases:
