...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Nemesis terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Nemesis itself, `model.provider: openai-codex` uses Nemesis-managed Codex
...
## Nemesis Gateway Caveat

When invoking the Codex CLI from a Nemesis gateway/service context (for example,
