...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/AxelGalvez11/nemesis-desktop/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/AxelGalvez11/nemesis-desktop.git",
    "git@github.com:AxelGalvez11/nemesis-desktop.git",
    "https://github.com/AxelGalvez11/nemesis-desktop",
    "git@github.com:AxelGalvez11/nemesis-desktop",
}
OFFICIAL_REPO_URL = "https://github.com/AxelGalvez11/nemesis-desktop.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss Nemesis Desktop updates.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/AxelGalvez11/nemesis-desktop.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/AxelGalvez11/nemesis-desktop.git' to add later."
            )
